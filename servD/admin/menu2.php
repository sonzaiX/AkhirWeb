  ...
  <nav>
    ...
    <div class="sidebar-links">
      <ul>
        ...
        <li>
          <a href="perbaikan.php" class="<?php echo ($activeIndex === 3) ? 'active' : ''; ?>" title="Reports Link">
            <div class="icon">
        ...
        <li>
          <a href="riwayat_perbaikan.php" class="<?php echo ($activeIndex === 4) ? 'active' : ''; ?>" title="Reports Link">
            <div class="icon">
                <img src="assets/reports.svg" title="Reports Icon">
            </div>
        ...
        <li>
          <a href="validasi.php" class="<?php echo ($activeIndex === 5) ? 'active' : ''; ?>" title="Reports Link">
            <div class="icon">
                <img src="assets/reports.svg" title="Reports Icon">
            </div>
